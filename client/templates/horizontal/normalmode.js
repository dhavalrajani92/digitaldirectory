shift = false,
    capslock = false;
var slider = null;
Template.normalmode.created = function() {
...
Template.normalmode.rendered = function() {
...
Template.normalmode.events({
  'click #normalemode':function(e,t){
    debugger;
    location.href="../directoryview/"+t.data.DirectoryDetails._id;
  },
